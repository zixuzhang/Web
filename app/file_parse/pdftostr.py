...
import re, os, StringIO, subprocess,logging,commands, sys
...
def pdftohtml(data):
    ...
    logging.info("开始命令行")
    a, b = commands.getstatusoutput('docker run -i --rm -v ~/Web/app/file_parse/cace:/pdf bwits/pdf2htmlex pdf2htmlEX --zoom 1.3 a.pdf')
    logging.info(a)
    logging.info("b:" + b)
