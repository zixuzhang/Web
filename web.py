# -*- coding: utf-8 -*-
import chardet, json, re, sys, zipfile
import gridfs
import tika
...
tika.initVM()
from file_parse.file_parse import File_Parse
from filedata_manage.filedata_manage import fulltext_search1, fulltext_search, fulltext_search_all
